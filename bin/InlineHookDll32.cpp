...
static BYTE g_OrigBytesNtOpenProcess[5];
static BYTE g_OrigBytesNtCreateFile[5];
static BYTE g_OrigBytesNtOpenFile[5];
...
// ================== 辅助函数（GCC 内联汇编） ==================
void WriteJump32(void* target, void* hook) {
    DWORD old;
...
void RestoreBytes32(void* target, BYTE* orig) {
    DWORD old;
    VirtualProtect(target, 5, PAGE_EXECUTE_READWRITE, &old);
    memcpy(target, orig, 5);
    VirtualProtect(target, 5, old, &old);
}
    ...
    PCLIENT_ID ClientId)
{
    ...
    RestoreBytes32((void*)OriginalNtOpenProcess, g_OrigBytesNtOpenProcess);
    NTSTATUS status = OriginalNtOpenProcess(ProcessHandle, DesiredAccess, ObjectAttributes, ClientId);
    WriteJump32((void*)OriginalNtOpenProcess, (void*)NtOpenProcess_Hook);
    return status;
}
    ...
    ULONG EaLength)
{
    ...
    RestoreBytes32((void*)OriginalNtCreateFile, g_OrigBytesNtCreateFile);
    ...
    WriteJump32((void*)OriginalNtCreateFile, (void*)NtCreateFile_Hook);
    return status;
}
    ...
    ULONG OpenOptions)
{
    ...
    RestoreBytes32((void*)OriginalNtOpenFile, g_OrigBytesNtOpenFile);
    NTSTATUS status = OriginalNtOpenFile(FileHandle, DesiredAccess, ObjectAttributes,
        IoStatusBlock, ShareAccess, OpenOptions);
    WriteJump32((void*)OriginalNtOpenFile, (void*)NtOpenFile_Hook);
    return status;
}
...
void InstallHooks() {
    ...
    memcpy(g_OrigBytesNtOpenProcess, (const void*)OriginalNtOpenProcess, 5);
    WriteJump32((void*)OriginalNtOpenProcess, (void*)NtOpenProcess_Hook);

    memcpy(g_OrigBytesNtCreateFile, (const void*)OriginalNtCreateFile, 5);
    WriteJump32((void*)OriginalNtCreateFile, (void*)NtCreateFile_Hook);

    memcpy(g_OrigBytesNtOpenFile, (const void*)OriginalNtOpenFile, 5);
    WriteJump32((void*)OriginalNtOpenFile, (void*)NtOpenFile_Hook);
}

void RemoveHooks() {
    if (OriginalNtOpenProcess) RestoreBytes32((void*)OriginalNtOpenProcess, g_OrigBytesNtOpenProcess);
    if (OriginalNtCreateFile) RestoreBytes32((void*)OriginalNtCreateFile, g_OrigBytesNtCreateFile);
